...
<h2>About</h2><p><?php echo ownerEscapeHtml(is_array($profile) ? ((string) ($profile['about_me'] ?: $profile['work_description'])) : 'Add profile information to preview it here.'); ?></p>
...
<h2 id="projects">Projects</h2><?php if ($projects === []): ?><p>No projects yet.</p><?php endif; ?><div class="admin-project-grid"><?php foreach ($projects as $project): ?><article><h3><?php echo ownerEscapeHtml((string) $project['title']); ?></h3><p><?php echo ownerEscapeHtml((string) $project['category']); ?></p><p><?php echo ownerEscapeHtml((string) $project['description']); ?></p></article><?php endforeach; ?></div>
<?php ownerLayoutEnd();
