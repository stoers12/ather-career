...
<div class="profile-photo-card">
    <div class="profile-photo-preview"><?php if (!empty($profile['profile_image_path'])): ?><img src="<?php echo ownerEscapeHtml((string) $profile['profile_image_path']); ?>" alt="<?php echo ownerEscapeHtml($profile['full_name']); ?>"><?php else: ?><span><?php echo ownerEscapeHtml(profileInitials($profile['full_name'] ?: 'P')); ?></span><?php endif; ?></div>
